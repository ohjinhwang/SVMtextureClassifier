...
% Load the data
data = cat(1,training,test);
label = cat(1,training_label,test_label);
...
label = trainLabel;
label_int(label == 0,1) = 1;
label_int(label == 1,1) = 2;
...
colorPlot = colorList(predictedLabel_int,:);
